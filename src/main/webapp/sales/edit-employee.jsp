							...
							<div class="container">
								<div class="main-body">
									<div class="row">
										<div class="card">
											<div class="card-body">
							<form id="form" method="POST" action="/employee/{{ data.id }}/edit">
								<div class="row mb-3 align-items-center">
														...
														<div class="row mb-3 align-items-center">
															...
															<div class="col-sm-9 text-secondary">
																<input type="text" id="qualifications" name="qualifications" class="form-control" value="{{ data.qualifications }}">
															</div>
														</div>
														<div class="row">
