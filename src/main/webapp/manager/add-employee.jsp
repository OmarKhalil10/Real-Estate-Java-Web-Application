                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Add Emplyoee</li>
                        </ol>
							...
							<div class="container">
								<div class="main-body">
									<div class="row">
											<div class="card">
												<div class="card-body">
							<form id="form" method="post" action="/employees/add">
								<div class="row mb-3 align-items-center">
									<div class="col-sm-3">
										<h6 class="mb-0">Full Name</h6>
									</div>
									<div class="col-sm-9 text-secondary">
										<input type="text" id="name" name="name" class="form-control" placeholder="Write name here..">
									</div>
								</div>
								<div class="row mb-3 align-items-center">
									<div class="col-sm-3">
									...
									<div class="col-sm-9 text-secondary">
										<input type="text" id="id_number" name="id_number" class="form-control" placeholder="30010012354678">
									</div>
								</div>
								<div class="row mb-3 align-items-center">
									<div class="col-sm-3">
									...
									<div class="col-sm-9 text-secondary">
										<input type="text" id="phone" name="phone" class="form-control" placeholder="+20 123 456 7891">
									</div>
								</div>
								<div class="row mb-3 align-items-center">
									<div class="col-sm-3">
									...
									<div class="col-sm-9 text-secondary">
										<input type="text" id="date_of_birth" name="date_of_birth" class="form-control" placeholder="2000-07-15">
									</div>
								</div>
								<div class="row mb-3 align-items-center">
									<div class="col-sm-3">
									...
									<div class="col-sm-9 text-secondary">
										<input type="text" id="address" name="address" class="form-control" placeholder="100 El-Thawra Street, Almazah, Heliopolis">
									</div>
								</div>
								<div class="row mb-3 align-items-center">
									<div class="col-sm-3">
									...
									<div class="col-sm-9 text-secondary">
										<input type="text" id="qualifications" name="qualifications" class="form-control" placeholder="Bacholar Degree in Computer Science">
									</div>
								</div>
								<div class="row mb-3 align-items-center">
									<div class="col-sm-3">
									...
									<div class="col-sm-9 text-secondary">
										<select class="form-select" id="job_title" name="job_title" aria-label="Default select example">
								...
								<div class="row mb-3 align-items-center">
									...
									<div class="col-sm-9 text-secondary">
										<input type="number" id="net_salary" name="net_salary" class="form-control" placeholder="4000">
									</div>
								</div>
								<div class="row">
