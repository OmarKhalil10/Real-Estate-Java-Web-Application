							...
							<div class="container">
								<div class="main-body">
									<div class="row">
										<div class="card">
											<div class="card-body">
                                                <form id="form" method="POST" action="/security/{{ data.id }}">
                                                    ...
                                                    {% endwith %}
                                                        <div class="form-floating mb-3">
                                                            <input class="form-control" id="old_password" name="old_password" type="password" placeholder="Create a password" required/>
                                                            <label for="inputPassword">Old Password</label>
                                                        </div>
                                                        <div class="form-floating mb-3">
                                                            <input class="form-control" id="new_password" name="new_password" type="password" placeholder="Create a password" required/>
                                                    ...
                                                    <div class="row">
                                                        <div class="text-secondary d-flex justify-content-between">
                                                            ...
                                                            <a class="btn btn-danger float-right" href="javascript:history.back()">Cancel</a>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
