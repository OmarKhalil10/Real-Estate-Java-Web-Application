            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <div class="d-flex">
                            <h1 class="mt-4">Leads Stage</h1>
                            <a href='/manager/confirm-import'>
                            <button type="button" class="btn ms-3 mt-4 mb-2 btn-primary">Save and Close</button>
                            </a> 
                        </div>
