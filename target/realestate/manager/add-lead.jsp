							...
							<div class="container">
								<div class="main-body">
									<div class="row">
											<div class="card">
												<div class="card-body">
													<form id="form" method="post" action="/manager/{{ data.id }}/add-lead">
														<div class="row mb-3 align-items-center">
															<div class="col-sm-3">
																<h6 class="mb-0">Client Name</h6>
															</div>
															<div class="col-sm-9 text-secondary">
																<input type="text" id="client_name" name="client_name" class="form-control" placeholder="Write name here.." required>
															</div>
														</div>
														<div class="row mb-3 align-items-center">
															<div class="col-sm-3">
															...
															<div class="col-sm-9 text-secondary">
																<input type="text" id="phone" name="phone" class="form-control" placeholder="01234567891" required>
															</div>
														</div>
														<div class="row mb-3 align-items-center">
															<div class="col-sm-3">
														...
														<div class="row mb-3 align-items-center">
															...
															<div class="col-sm-9 text-secondary">
																<input type="text" id="request" name="request" class="form-control" placeholder="Write ad request here..">
															</div>
														</div>
                                                        <div class="row mb-3 align-items-center">
															<div class="col-sm-3">
																<h6 class="mb-0">Client Job</h6>
															</div>
															<div class="col-sm-9 text-secondary">
																<input type="text" id="client_job" name="client_job" class="form-control" placeholder="Write client job here..">
															</div>
														</div>
                                                        <div class="row mb-3 align-items-center">
															<div class="col-sm-3">
															...
															<div class="col-sm-9 text-secondary">
																<input type="text" id="ad_details" name="ad_details" class="form-control" placeholder="Write ad details here..">
															</div>
														</div>
                                                        <div class="row mb-3 align-items-center">
															<div class="col-sm-3">
															...
															<div class="col-sm-9 text-secondary">
																<input type="text" id="campaign" name="campaign" class="form-control" placeholder="Write campain here..">
															</div>
														</div>
                                                        <div class="row mb-3 align-items-center">
															<div class="col-sm-3">
                                                            ...
                                                            <div class="col-sm-9 text-secondary">
                                                                <select class="form-select" id="round" name="round" aria-label="Default select example" required>
                                                                    <option disabled>Round</option>
                                                                    <option selected value="New">New</option>
                                                                    <option selected value="New Cold">New Cold</option>
