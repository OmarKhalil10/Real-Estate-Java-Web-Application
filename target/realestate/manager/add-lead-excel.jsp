							...
							<div class="container">
								<div class="main-body">
									<div class="row">
                                        <div class="card">
                                            <div class="card-body">
                                                <h1 class="pb-3">Excel file upload (xls, xlsx, ods please) <a href="/static/files/leads-template.xls" download="leads-template.xls"><button type="button" class="btn btn-success">Download Template</button></a></h1>
