                    ...
                    <div class="container-fluid px-4">
                        ...
                        <table border="0" cellspacing="5" cellpadding="5">
                            ...
                            <tr>
                                ...
                                <table id="example" class="compact cell-border stripe hover" style="width:100%">
                                    <thead>
                                        <tr>
                                          <th></th>
                                          <th>Created Time</th>
                                        ...
                                        <tr>
                                          <td>
                                            <div class="btn-group" role="group">
                                                <div> 
                                                    <a class="btn btn-secondary" href="/leads/{{ data.id }}/edit-delayed/{{ d.id }}"><i class="far fa-edit"></i></a>
                                                </div>
